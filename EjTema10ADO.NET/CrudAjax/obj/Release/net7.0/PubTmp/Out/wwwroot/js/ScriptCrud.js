...
//https://crudnervion.azurewebsites.net/api/personas
...
function PeticionDepartamentos() {
    return new Promise((resolve, reject) => {
        ...
        let arrayDatosDeps;
        miPeticion.open("GET", "https://crudnervion.azurewebsites.net/api/departamentos");
...
function PeticionPersonas() {
    return new Promise((resolve, reject) => {
        ...
        miPeticion.open("GET", "https://crudnervion.azurewebsites.net/api/personas");
        miPeticion.onreadystatechange = function () {
            if (miPeticion.readyState < 4) {
                miP.innerHTML = "Cargando";
            } else if (miPeticion.readyState == 4) {
...
function PeticionModificarPersona(personaModificable) {
    return new Promise((resolve, reject) => {
        ...
        let miPeticion = new XMLHttpRequest();
        miPeticion.open("PUT", "https://crudnervion.azurewebsites.net/api/personas/" + personaModificable.id);
...
function PeticionModificarDepartamento(depModificable) {
    return new Promise((resolve, reject) => {
        ...
        let miPeticion = new XMLHttpRequest();
        miPeticion.open("PUT", "https://crudnervion.azurewebsites.net/api/departamentos" + depModificable.id);
        miPeticion.setRequestHeader("Content-Type", "application/json");//especifico el tipo de contenido que voy a enviar, necesario porque es un put
        miPeticion.onreadystatechange = function () {
            if (miPeticion.readyState < 4) {
                miP.innerHTML = "Cargando";
